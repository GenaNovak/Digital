	...
	def writeLines(self, letters):
		with open(self.m_fileName, 'a') as csvFile:
			...
			for letter in letters:
				row = {"Date" : letter.m_date.m_dateStr, "adressee" : letter.m_to, "From" : letter.m_from, "Location" : letter.m_location, "Number of words(without stop words)" : letter.m_numberOfWords, "Number of words" : letter.m_numberOfWordsWithoutStopWords, "filename" : letter.m_letterPath}
				writer.writerow(row)
